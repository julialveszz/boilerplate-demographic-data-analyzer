...
def calculate_demographic_data(print_data=True):
    ...
    higher_education_rich = ((df[advanced_education & (df['salary'] == '>50K')].shape[0]) /
                             df[advanced_education].shape[0] * 100).round(1)

    lower_education = ~advanced_education
    lower_education_rich = ((df[lower_education & (df['salary'] == '>50K')].shape[0]) /
                            df[lower_education].shape[0] * 100).round(1)
    ...
    rich_percentage = ((num_min_workers[num_min_workers['salary'] == '>50K'].shape[0]) /
                       num_min_workers.shape[0] * 100).round(1)
    ...
    top_IN_occupation = india_occupations.mode()[0]
